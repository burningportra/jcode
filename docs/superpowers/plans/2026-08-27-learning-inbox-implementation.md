...
3. Add a small bus payload and TUI background refresh path after successful turns backed by the local daemon. Explicit remote workspaces fail closed until discovery has a server-owned protocol.
