...
impl App {
    ...
    pub(super) fn new_minimal_with_session(
        ...
        let mut app = Self {
            ...
            input: String::new(),
            prompt_suggestion: prompt_suggestion::PromptSuggestionState::default(),
            command_candidates_cache: RefCell::new(None),
            command_suggestions_cache: RefCell::new(None),
            file_mentions: RefCell::new(file_mentions::FileMentionState::default()),
            ...
            remote_resolved_model: None,
            remote_auto_state: None,
            ...
            is_remote: false,
            learning_inbox_store_is_local: true,
